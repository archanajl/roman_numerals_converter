...
public class InputConsole {
    ...
    public void convertNumeral() {
        try {
            ...
            if (input_numeral.trim().equals("")){
                // No numerals entered
                printStream.println("No Numeral entered.");
                ...
                printStream.println("You converted the Roman Numeral "
                        ...
                        + this.numeralMap.get(input_numeral.trim()).toString() + ".");
            } else {
                // Invalid numeral entered
                printStream.println("The Roman Numeral "
                        + input_numeral.trim() + ", you entered is invalid.");
            }
        }catch (Exception e){
